...
static int kindMatchFilter = 0;
static const char * kinds;
static int nameOnly = 0;
...
"Options:\n"
"    -n           No filename and No pattern \n"
"    -k kinds     kindMatchFilter \n"
